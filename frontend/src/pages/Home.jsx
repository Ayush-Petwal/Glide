...
const Home = () => {
  return (
    <div>
        <div className=' bg-cover bg-center  bg-[url(https://mir-s3-cdn-cf.behance.net/project_modules/disp/c5310f182519763.652f3606b64b0.jpg)] h-screen pt-8 w-full flex justify-between flex-col bg-red-400 '>
